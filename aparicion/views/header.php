    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <form class="navbar-form navbar-right" action="<?php echo base_url();?>cliente/buscar" method="POST">
                    <div class="input-group">
                        <input id="cliente_a_buscar" name="cliente_a_buscar" type="text" class="form-control" placeholder="Buscar cliente...">
                        <span class="input-group-btn">
                            <button class="btn btn-default" type="submit" type="button"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                        </span>
                    </div>
                    <a href="<?php echo base_url();?>cerrar_sesion" title="Salir"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span></a> 
                    <a href="<?php echo base_url();?>cliente/registrar"  title="Nuevo Cliente"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a> 
                    <!-- <a href="<?php echo base_url();?>recomendaciones"  title="Recomendaciones"><span class="glyphicon glyphicon-gift" aria-hidden="true"></span></a> -->
                    <a href="<?php echo base_url();?>mi_perfil"  title="Mi Perfil"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a> 
                </form>
            </div>
        </div>
    </nav>
