...
{   
    imprimir_mensaje("No se encontr¨® cliente.",'advertencia');
}
else{ 
    ?>
    <div class="col-xs-12 datos_clientes" >
        ...
        <div class="col-sm-6">
            ...
            <div class="input-group">
                <span class="input-group-addon" id="basic-addon1"> <a href='tel:"<?php echo $datos_cliente['celular'];?>"'><span class="glyphicon glyphicon-earphone"></span></a></span>
